...
public class FormularioUDP extends javax.swing.JDialog {
    ...
    private void btnReq1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReq1ActionPerformed
        try {
            ...
            txtResposta.setText(ClienteUDP.enviarRequisicao("1;" + txtCampo.getText()));
            //        txtResposta.setText(clienteUDP.enviaMensagem(txtCampo.getText()));
        } catch (Exception ex) {
            Logger.getLogger(FormularioUDP.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnReq2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReq2ActionPerformed
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (txtCampo.getText().isEmpty()) {
                txtResposta.setText("Usuário não existe");
            } else {
                try {
                    // txtResposta.setText("2;" + txtCampo.getText() + ";" + nota);
                    txtResposta.setText(ClienteUDP.enviarRequisicao("2;" + txtCampo.getText()+ ";" + String.valueOf(nota)));
                } catch (Exception ex) {
                    Logger.getLogger(FormularioUDP.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void btnReq3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReq3ActionPerformed
        try {
            // TODO add your handling code here:
            txtResposta.setText(ClienteUDP.enviarRequisicao("3;" + txtCampo.getText()));
            //        txtResposta.setText(clienteUDP.enviaMensagem(txtCampo.getText()));
        } catch (Exception ex) {
            Logger.getLogger(FormularioUDP.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnReq4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReq4ActionPerformed
        try {
            // TODO add your handling code here:
            txtResposta.setText(ClienteUDP.enviarRequisicao("4;" + txtCampo.getText()));
            //        txtResposta.setText(clienteUDP.enviaMensagem(txtCampo.getText()));
        } catch (Exception ex) {
            Logger.getLogger(FormularioUDP.class.getName()).log(Level.SEVERE, null, ex);
        }
